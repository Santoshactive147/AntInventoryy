...
# load_dotenv(dotenv_path=r'C:\Users\santo\Desktop\Santosh\Ant Project\ant-inventree\contrib\container\.env')
load_dotenv()
print("helllooooo ******************")
...
# INVENTREE_STATIC_ROOT = config.get_static_dir()

STATIC_ROOT = os.path.join(BASE_DIR, 'InvenTree/static')
INVENTREE_STATIC_ROOT = 'C:/Users/santo/Desktop/Santosh/Ant Project/ant-inventree/src/backend/InvenTree/InvenTree/static'


# The filesystem location for uploaded meadia files
MEDIA_ROOT = os.path.join(BASE_DIR, 'InvenTree/media')
